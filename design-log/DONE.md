...
### 2026-08-09 — v1.6.7: compatibility declarations bump
**What:** Updated "tested up to" declarations to WordPress 7.0.3 and WooCommerce 11.0.0 (previously 7.0 / 10.6.1-10.7.0 across the readme files).
**How:** Version bump (no functional code change) + changelog entries in both readme files.
